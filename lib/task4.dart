                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: Container(
                            height: 60,
                            width: 120,
                            decoration: BoxDecoration(color: const Color.fromARGB(255, 42, 41, 41),borderRadius: BorderRadius.circular(15)),
                            child: TextButton(onPressed: (){}, child: Text(name[index],style: TextStyle(color: Colors.white),))),
